...
- **Investigating Voiced and Unvoiced Regions of Speech for Audio Deepfake Detection**  
  ...
  [paper](https://ieeexplore.ieee.org/document/10890861?denied=)
  *IEEE ICASSP 2025*
...
- **Source Tracing of Audio Deepfake Systems**  
  ...
  *Interspeech 2024*
  [Paper](https://arxiv.org/abs/2407.08016)
  [Protocol](https://zenodo.org/records/11593133)

- **Harder or Different? Understanding Generalization of Audio Deepfake Detection**  
  Nicolas M Müller, Nicholas Evans, **Hemlata Tak**, Philip Sperl, Konstantin Böttinger
  *Interspeech 2024*
  [Paper](https://arxiv.org/pdf/2406.03512)
...
- **To what extent can ASV systems naturally defend against spoofing attacks?**  
  ...
  *Interspeech 2024*  
  [Paper](https://arxiv.org/pdf/2406.05339)
...
- **End-to-End Modeling for Speech Spoofing and Deepfake Detection**  
  **Hemlata Tak**   
  [Thesis](https://www.eurecom.fr/publication/7273)
  [Slides](https://drive.google.com/file/d/17qnfPJ7ESdXza0dYzG6h8Cbv3RmYyLnI/view?usp=sharing)
...
- **From Artefacts to Insights:A Topical Analysis of Voice Biometric Security**  
  ...
  *Joint Workshop of VoicePersonae and ASVspoof 2023, NII, Tokyo, Japan*  
  [Slides](https://drive.google.com/file/d/1XAX2vN-ghHM9KMhXjctYe0GT0uXPON8j/view?usp=sharing)
...
- **Malafide: a novel adversarial convolutive noise attack against deepfake and spoofing detection systems**  
  ...
  *Interspeech 2023*  
  [Paper](https://arxiv.org/abs/2306.07655)
  [Code](github.com/eurecom-asp/malafide)
...
- **Towards single integrated spoofing-aware speaker verification embeddings**  
  ...
  *Interspeech 2023*  
  [Paper](https://arxiv.org/abs/2305.19051)
  [Code](https://github.com/sasv-challenge/ASVSpoof5-SASVBaseline)

- **Can spoofing countermeasure and speaker verification systems be jointly optimised?**  
  Wanying Ge, **Hemlata Tak**, Massimiliano Todisco, Nicholas Evans  
  *IEEE ICASSP 2023*  
  [Paper](https://ieeexplore.ieee.org/abstract/document/10095068)
  [Code](https://github.com/eurecom-asp/sasv-joint-optimisation)
...
- **On the potential of jointly-optimised solutions to spoofing attack detection and automatic speaker verification**  
  ...
  *ISCA IberSPEECH 2022 (Best paper award)*  
  [Paper](https://www.isca-speech.org/archive/iberspeech_2022/ge22_iberspeech.html)
  [Code](https://github.com/eurecom-asp/sasv-joint-optimisation)
...
- **SASV 2022: The First Spoofing-Aware Speaker Verification Challenge**  
  ...
  *Interspeech 2022*  
  [Paper](https://www.isca-speech.org/archive/interspeech_2022/jung22c_interspeech.html)
  [Code](https://sasv-challenge.github.io)
...
- **Automatic speaker verification spoofing and deepfake detection using wav2vec 2.0 and data augmentation**  
  ...
  *The Speaker and Language Recognition Workshop (Odyssey 2022)*  
  [Paper](https://www.isca-speech.org/archive/odyssey_2022/tak22_odyssey.html)
...
- **Baseline systems for the first spoofing-aware speaker verification challenge: score and embedding fusion**  
  ...
  *The Speaker and Language Recognition Workshop (Odyssey 2022)*  
  [Paper](https://www.isca-speech.org/archive/odyssey_2022/shim22_odyssey.html)
  
- **Rawboost: A raw data boosting and augmentation method applied to automatic speaker verification anti-spoofing**  
  **Hemlata Tak**, Madhu Kamble, Jose Patino, Massimiliano Todisco, Nicholas Evans  
  *IEEE ICASSP 2022*  
  [Paper](https://ieeexplore.ieee.org/abstract/document/9746213)
...
- **Aasist: Audio anti-spoofing using integrated spectro-temporal graph attention networks**  
  ...
  *IEEE ICASSP 2022*  
  [Paper](https://ieeexplore.ieee.org/abstract/document/9747766)
...
- **End-to-end spectro-temporal graph attention networks for speaker verification anti-spoofing and speech deepfake detection**  
  ...
  *2021 Edition of the Automatic Speaker Verification and Spoofing Countermeasures Challenge (Interspeech 2021 satellite workshop)*  
  [Paper](https://www.isca-speech.org/archive/asvspoof_2021/tak21_asvspoof.html)
  [Code](https://github.com/eurecom-asp/RawGAT-ST-antispoofing)

- **Graph attention networks for anti-spoofing**  
  **Hemlata Tak**, Jee-weon Jung, Jose Patino, Massimiliano Todisco, Nicholas Evans  
  *Interspeech 2021*  
  [Paper](https://www.isca-speech.org/archive/interspeech_2021/tak21_interspeech.html)
...
- **Privacy-Preserving Voice Anti-Spoofing Using Secure Multi-Party Computation**  
  ...
  *Interspeech 2021*  
  [Paper](https://www.isca-speech.org/archive/interspeech_2021/chouchane21_interspeech.html)
 
- **End-to-end anti-spoofing with rawnet2**  
  **Hemlata Tak**, Jose Patino, Massimiliano Todisco, Andreas Nautsch, Nicholas Evans, Anthony Larcher
  *IEEE ICASSP 2021*  
  [Paper](https://ieeexplore.ieee.org/abstract/document/9414234)
...
- **Amplitude and frequency modulation-based features for detection of replay spoof speech**  
  ...
  *Speech Communication 2020*  
  [Paper](https://www.sciencedirect.com/science/article/abs/pii/S016763932030279X#:~:text=Highlights&text=The%20replay%20Spoof%20Speech%20Detection,%2C%20playback%2C%20and%20recording%20device.&text=The%20slow%20and%20fast%2Dvarying,compared%20to%20the%20natural%20speech.)
...
- **Spoofing attack detection using the non-linear fusion of sub-band classifiers**  
  ...
  *Interspeech 2020*  
  [Paper](https://www.isca-speech.org/archive/interspeech_2020/tak20_interspeech.html)
...
- **An explainability study of the constant Q cepstral coefficient spoofing countermeasure for automatic speaker verification**  
  ...
  *The Speaker and Language Recognition Workshop 2020*  
  [Paper](https://www.isca-speech.org/archive/odyssey_2020/tak20_odyssey.html)
...
- **Novel Linear Frequency Residual Cepstral Features for Replay Attack Detection**  
  ...
  *Interspeech 2018*  
  [Paper](https://www.isca-speech.org/archive/interspeech_2018/tak18_interspeech.html)

- **Effectiveness of Speech Demodulation-Based Features for Replay Detection**  
  Madhu R Kamble, **Hemlata Tak**, Hemant A Patil
  *Interspeech 2018*  
  [Paper](https://www.isca-speech.org/archive/interspeech_2018/kamble18_interspeech.html)
...
- **Novel demodulation-based features using classifier-level fusion of GMM and CNN for replay detection**  
  ...
  *11th International Symposium on Chinese Spoken Language Processing (ISCSLP) 2018*  
  [Paper](https://ieeexplore.ieee.org/document/8706648)
